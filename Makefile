...
selection.o: selection.h selection.c view.h types.h object.h
	gcc selection.c -c `pkg-config --cflags  gtk+-3.0` -O3
...
fcad: fcad.o view.o  ruler.o grid.o element.o document.o \
      parser.o object.o obj_line.o obj_pad.o obj_pin.o parm.o selection.o
