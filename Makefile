...
document.o: document.c document.h view.h pad.h
...
fcad: fcad.o view.o  ruler.o grid.o document.o pad.o
	gcc -g -o fcad fcad.o view.o  ruler.o grid.o document.o pad.o\
